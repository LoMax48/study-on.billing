 ...
 */
final class Version20220712222252 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE transaction (id INT NOT NULL, billing_user_id INT NOT NULL, course_id INT DEFAULT NULL, type SMALLINT NOT NULL, amount DOUBLE PRECISION DEFAULT NULL, operation_time TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, expires_time TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
